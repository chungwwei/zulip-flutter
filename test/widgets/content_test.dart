...
void main() {
  ...
  group('UserMention', () {
    ...
    group('onTap navigates to profile page', () {
      ...
      userMentionNavigationTest(description: 'tapping channelWildcardMentionSilentClassOrderReversed does nothing',
        example: ContentExample.channelWildcardMentionSilentClassOrderReversed, expectedUserId: null);
      ...
      userMentionNavigationTest(description: 'tapping legacyChannelWildcardMentionSilentClassOrderReversed does nothing',
        example: ContentExample.channelWildcardMentionSilentClassOrderReversed, expectedUserId: null);
      ...
      userMentionNavigationTest(description: 'tapping topicMentionSilentClassOrderReversed does nothing',
        example: ContentExample.topicMentionSilentClassOrderReversed, expectedUserId: null);
    });
